...
@Component("CDARichHeading")
public class RichHeadingParser extends AbstractRichNodeParser<CDARichHeading> {
    ...
    @Override
    public RichNode parseContent(CDARichHeading h, List<RichNode> content) {
        return new RichBlock("heading-" + h.getLevel(), content);
    }
}
